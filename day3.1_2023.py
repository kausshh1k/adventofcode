lines = '''...........................................751........501...................................890.231...............829..168......143.........
......................................*.........841....*....../................+..311.......................441..........*...........202....
...
for r in range(len(lines)):
    for c, ch in enumerate(lines[r]):
        if ch == '-' and c + 1 in range(len(lines[r])) and lines[r][c + 1] in '0123456789': continue
        elif ch !='.' and ch not in '0123456789': symPos.add((r, c))

def isValidNum(arr):
    sr, sc = arr[0]
    for dr, dc in [[-1, -1], [0, -1], [1, -1], [-1, 0], [1, 0]]:
        if (sr + dr, sc + dc) in symPos: return True
    
    er, ec = arr[-1]
    for dr, dc in [[-1, 1], [0, 1], [1, 1], [-1, 0], [1, 0]]:
        if (er + dr, ec + dc) in symPos: return True
...
def isNeg(arr):
    sr, sc = arr[0]
    if sc - 1 in range(len(lines[sr])) and lines[sr][sc - 1] == '-': return True
    return False
...
for r in range(len(lines)):
    for c, ch in enumerate(lines[r]):
        if ch == '-' and c + 1 in range(len(lines[r])) and lines[r][c + 1] in '0123456789':
            # print(r, c)
            num[0] += ch
            num[1].append((r, c))
            # continue
